...
@endsection
@section('content')
<a href="javascript:void(0)" class="text-primary view-certificate-btn"><i class="bi bi-eye-fill"></i></a>
    <main class="main blurred" id="main">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <ul class="nav nav-pills">
                ...
                <li class="nav-item">
                    <button class="nav-link">Sertifikatlar</button>
                </li>
            </ul>
        ...
        <div class="order-row d-flex justify-content-between align-items-center px-3 py-2 mb-2 bg-light border">
            <span class="text-primary">Sertifikat N-1</span>
                                    ...
                                    <div class="card assignees-card shadow-sm border-primary-subtle">
                                        <div class="card-header d-flex justify-content-between align-items-center py-2">
                                            <span class="fw-semibold">
                                                <i class="bi bi-file-earmark-ruled me-2"></i>Sertifikat
                                            </span>
        ...
        document.addEventListener("click", function(e) {
            if (e.target.classList.contains("btn-delete")) {
                ...
                Swal.fire({
                    ...
                    text: "Bu sertifikatı silmək istədiyinizə əminsiniz?",
                    icon: "warning",
                    ...
                    if (result.isConfirmed) {
                        ...
                        Swal.fire({
                            title: "Silindi!",
                            text: "Sertifikat uğurla silindi.",
                            icon: "success",
                            timer: 1300,
